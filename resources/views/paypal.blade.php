    ...
    <div class="container">
        <div class="gateway--info">
            <div class="gateway--desc">
                ...
                <p>Amount : ${{ $order->totalPedido }}</p>
                <hr>
            </div>
            <div class="gateway--paypal">
                {{--['order' => encrypt(mt_rand(1, 140))]--}}
                <form method="POST" action="{{ route('checkout.payment.paypal', ['order' =>encrypt($order->numIdentificacionPedido)]) }}">
                    {{ csrf_field() }}
