...
@section('adminContent')
    <div class="breadcrumb">
        <a href="{{url('admin')}}">Administraci&oacute;n</a> <span class="glyphicon glyphicon-chevron-right"></span> <a
                href="{{url('admin/pedidos')}}">Pedidos</a> <span class="glyphicon glyphicon-chevron-right"></span>
        <a href="{{url('admin/pedidos/enviados')}}">Pedidos Enviados</a>
    ...
    <ul class="list-group">
        ...
        @endforeach
            @else
            <h3><span class="label label-default">No hay pedidos enviados aun</span></h3>
        @endif
    </ul>
